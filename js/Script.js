window.addEventListener('DOMContentLoaded', () => {
    ...
    function setCock (selector, endTime) {
    ...
    class MenuCart {
        constructor(src, alt, title, descr, price, parentSeector) {
            this.src = src;
            this.alt = alt;
            this.title = title;
            this.descr = descr;
            this.price = price;
            this.parent = document.querySelector(parentSeector);
            this.transfer = 27;
            this.changeToUAH();
        }
